...
def list_installation_services_v2(
...
@router.post("/installation-requests", response_model=InstallationRequestOut, status_code=201)
def create_installation_request_v2(
