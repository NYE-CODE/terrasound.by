...
router = APIRouter(prefix=API_V2_PREFIX, tags=["content"])
...
def get_blog_post_v2(post_id: str, db: Annotated[Session, Depends(get_db)]) -> BlogPostDetailOut:
    item = (
        db.query(BlogPost)
